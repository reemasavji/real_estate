...
def realtors(request):
	...
	return render(request, 'real_estate_app/realtors.html', context)
...
def realtor(request,id):
	...
	return render(request, 'real_estate_app/realtor.html', context)
...
def realtor_add(request):
	if request.method == 'POST':
		...
		form = RealtorForm()
		return render(request,'real_estate_app/realtor_form.html',{'form':form})
...
def realtor_update(request,id):
	...
	if request.method == 'POST':
		...
		return render(request,'real_estate_app/realtor_form.html',{'form':form,'edit':True})
